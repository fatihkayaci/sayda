...
class VizyonMisyon extends DCLogic {
  state = { menu: null };
  componentDidMount() {
  ...
  render() {
    const { toggleMobile, closeMenu, navPad, navTrack, burger, navShown, mobileOpen, nav, footerCols } = this.renderVals();
    return (
      <>
        <style dangerouslySetInnerHTML={{ __html: ".vizyonmisyon-h0:hover{background:#2F3091 !important;color:#fff !important}\n.vizyonmisyon-h1:hover{background:#2F3091 !important;color:#fff !important}\n.vizyonmisyon-h2:hover{color:#fff !important}\n.vizyonmisyon-h3:hover{color:#fff !important}\n.vizyonmisyon-h4:hover{background:#2F3091 !important;color:#fff !important}\n.vizyonmisyon-h5:hover{border-color:#fff !important;color:#fff !important}\n.vizyonmisyon-h6:hover{border-color:#fff !important;color:#fff !important}\n.vizyonmisyon-h7:hover{border-color:#fff !important;color:#fff !important}\n.vizyonmisyon-h8:hover{color:#fff !important}\n.vizyonmisyon-h9:hover{color:#fff !important}\n.vizyonmisyon-h10:hover{color:#fff !important}" }} />
...
<section data-screen-label="Vizyon Misyon Hero" style={{"position":"relative","background":"#0D1533","color":"#fff","overflow":"hidden"}}>
  <div style={{"position":"absolute","top":"0","right":"0","bottom":"0","width":"52%"}}>
    <img src="https://sayda-chi.vercel.app/img/projects/vadistanbul/vadistanbul.webp" alt="Sayda İnşaat" style={{"width":"100%","height":"100%","objectFit":"cover","display":"block"}} />
  ...
  <div style={{"position":"relative","maxWidth":"1400px","margin":"0 auto","padding":"72px 40px 96px","minHeight":"600px","display":"grid","gridTemplateColumns":"repeat(auto-fit,minmax(min(460px,100%),1fr))","gap":"48px","alignItems":"end"}}>
    <div>
      <div style={{"display":"flex","alignItems":"center","gap":"10px","fontSize":"13px","fontWeight":"500","color":"rgba(246,247,251,0.6)","marginBottom":"64px"}}>
        <a href="/" style={{"color":"rgba(246,247,251,0.6)"}} className="vizyonmisyon-h2">Ana Sayfa</a><span>/</span><a href="/kurumsal" style={{"color":"rgba(246,247,251,0.6)"}} className="vizyonmisyon-h3">Kurumsal</a><span>/</span><span style={{"color":"#F6F7FB"}}>Vizyon &amp; Misyon</span>
      </div>
      ...
      <h1 style={{"margin":"0","fontStretch":"125%","fontWeight":"800","fontSize":"clamp(44px,6vw,92px)","lineHeight":"0.95","letterSpacing":"-0.01em","textTransform":"uppercase"}}>Vizyon<br /><span style={{"fontWeight":"300","color":"#8589E6"}}>&amp; Misyon</span></h1>
      <p style={{"margin":"30px 0 0","maxWidth":"520px","fontSize":"18px","lineHeight":"1.65","color":"rgba(246,247,251,0.8)","textWrap":"pretty"}}>Daha iyi yaşam alanları için bugünün ihtiyaçlarını geleceğin değerleriyle birleştiriyoruz.</p>
    </div>
    <div style={{"display":"flex","justifyContent":"flex-end"}}>
      <div style={{"maxWidth":"380px","borderLeft":"2px solid #8589E6","padding":"4px 0 4px 28px"}}>
        <div style={{"fontSize":"clamp(24px,2.4vw,34px)","fontWeight":"600","fontStretch":"112%","lineHeight":"1.2","textTransform":"uppercase","letterSpacing":"0.01em"}}>“Yaşam alanlarına değer katıyoruz”</div>
      </div>
    </div>
  </div>
</section>

<section data-screen-label="Misyon" style={{"background":"#fff"}}>
  <div style={{"maxWidth":"1400px","margin":"0 auto","padding":"120px 40px","display":"grid","gridTemplateColumns":"repeat(auto-fit,minmax(min(440px,100%),1fr))","gap":"88px","alignItems":"center"}}>
      <div style={{"position":"relative","aspectRatio":"5/4","overflow":"hidden","background":"#E4E5F2"}}>
        <img src="https://sayda-chi.vercel.app/img/projects/varyap-meridien-konut/varyap-meridien-konut.webp" alt="Misyon" style={{"width":"100%","height":"100%","objectFit":"cover","display":"block"}} />
        <div style={{"position":"absolute","left":"0","bottom":"0","background":"#2F3091","color":"#fff","padding":"18px 26px","fontSize":"44px","fontWeight":"800","fontStretch":"120%","lineHeight":"1"}}>01</div>
      </div>
      <div>
        <div style={{"display":"flex","alignItems":"center","gap":"14px","fontSize":"13px","fontWeight":"700","letterSpacing":"0.22em","textTransform":"uppercase","color":"#2F3091","marginBottom":"20px"}}><span style={{"width":"10px","height":"10px","background":"#3E43B8","transform":"rotate(45deg)"}}></span>Misyon</div>
        <h2 style={{"margin":"0","fontSize":"clamp(34px,3.6vw,52px)","lineHeight":"1.04","fontWeight":"700","fontStretch":"112%","letterSpacing":"-0.015em","textWrap":"balance"}}>Değer üretmek için çalışıyoruz.</h2>
        <p style={{"margin":"28px 0 0","maxWidth":"560px","fontSize":"18px","lineHeight":"1.75","color":"#2A2C4A","textWrap":"pretty"}}>Toplum ve çevre bilincinde, ahlaki değerler doğrultusunda, müşteri ve çalışanlarımızın memnuniyetini temel alarak en yüksek verim ve kaliteyle hizmet ve ürünler sunmak.</p>
      </div>
  </div>
</section>
<section data-screen-label="Vizyon" style={{"background":"#F6F7FB"}}>
  <div style={{"maxWidth":"1400px","margin":"0 auto","padding":"120px 40px","display":"grid","gridTemplateColumns":"repeat(auto-fit,minmax(min(440px,100%),1fr))","gap":"88px","alignItems":"center"}}>
      <div>
        <div style={{"display":"flex","alignItems":"center","gap":"14px","fontSize":"13px","fontWeight":"700","letterSpacing":"0.22em","textTransform":"uppercase","color":"#2F3091","marginBottom":"20px"}}><span style={{"width":"10px","height":"10px","background":"#3E43B8","transform":"rotate(45deg)"}}></span>Vizyon</div>
        <h2 style={{"margin":"0","fontSize":"clamp(34px,3.6vw,52px)","lineHeight":"1.04","fontWeight":"700","fontStretch":"112%","letterSpacing":"-0.015em","textWrap":"balance"}}>Daima daha iyisi için gelişiyoruz.</h2>
        <p style={{"margin":"28px 0 0","maxWidth":"560px","fontSize":"18px","lineHeight":"1.75","color":"#2A2C4A","textWrap":"pretty"}}>Araştırmacı ve teknolojik gelişimlerin takipçisi olarak daha verimli sistemler oluşturmak; sektörde yenilikçi ve güvenilir bir marka olarak tercih edilmek.</p>
      </div>
      <div style={{"position":"relative","aspectRatio":"5/4","overflow":"hidden","background":"#E4E5F2"}}>
        <img src="https://sayda-chi.vercel.app/img/projects/vadistanbul/vadistanbul.webp" alt="Vizyon" style={{"width":"100%","height":"100%","objectFit":"cover","display":"block"}} />
        <div style={{"position":"absolute","right":"0","bottom":"0","background":"#2F3091","color":"#fff","padding":"18px 26px","fontSize":"44px","fontWeight":"800","fontStretch":"120%","lineHeight":"1"}}>02</div>
      </div>
  </div>
</section>
<section data-screen-label="Hedef" style={{"background":"#fff"}}>
  <div style={{"maxWidth":"1400px","margin":"0 auto","padding":"120px 40px","display":"grid","gridTemplateColumns":"repeat(auto-fit,minmax(min(440px,100%),1fr))","gap":"88px","alignItems":"center"}}>
      <div style={{"position":"relative","aspectRatio":"5/4","overflow":"hidden","background":"#E4E5F2"}}>
        <img src="https://sayda-chi.vercel.app/img/sayda-insaat-hero01.webp" alt="Hedef" style={{"width":"100%","height":"100%","objectFit":"cover","display":"block"}} />
        <div style={{"position":"absolute","left":"0","bottom":"0","background":"#2F3091","color":"#fff","padding":"18px 26px","fontSize":"44px","fontWeight":"800","fontStretch":"120%","lineHeight":"1"}}>03</div>
      </div>
      <div>
        <div style={{"display":"flex","alignItems":"center","gap":"14px","fontSize":"13px","fontWeight":"700","letterSpacing":"0.22em","textTransform":"uppercase","color":"#2F3091","marginBottom":"20px"}}><span style={{"width":"10px","height":"10px","background":"#3E43B8","transform":"rotate(45deg)"}}></span>Hedef</div>
        <h2 style={{"margin":"0","fontSize":"clamp(34px,3.6vw,52px)","lineHeight":"1.04","fontWeight":"700","fontStretch":"112%","letterSpacing":"-0.015em","textWrap":"balance"}}>Daha güçlü yarınlar için.</h2>
        <p style={{"margin":"28px 0 0","maxWidth":"560px","fontSize":"18px","lineHeight":"1.75","color":"#2A2C4A","textWrap":"pretty"}}>Türkiye ve uluslararası platformda sektörün öne gelen şirketlerinden biri olmak; sürdürülebilir projelerle yaşam alanlarına kalıcı değerler kazandırmak.</p>
      </div>
  </div>
</section>
<section data-screen-label="Söz" style={{"background":"#F6F7FB"}}>
  <div style={{"maxWidth":"1000px","margin":"0 auto","padding":"96px 40px","display":"flex","flexDirection":"column","alignItems":"center","textAlign":"center","gap":"28px"}}>
    <div style={{"display":"flex","alignItems":"center","gap":"16px"}}>
      <span style={{"width":"48px","height":"1px","background":"rgba(47,48,145,0.35)"}}></span>
      <span style={{"width":"10px","height":"10px","background":"#3E43B8","transform":"rotate(45deg)"}}></span>
      <span style={{"width":"48px","height":"1px","background":"rgba(47,48,145,0.35)"}}></span>
    </div>
    <div style={{"fontSize":"clamp(26px,2.6vw,36px)","fontWeight":"600","fontStretch":"108%","lineHeight":"1.3","color":"#15182B","textWrap":"balance"}}>“Güvenli yapılar, <span style={{"color":"#2F3091"}}>daha iyi yaşamlar.</span>”</div>
    <div style={{"fontSize":"12px","fontWeight":"600","letterSpacing":"0.28em","textTransform":"uppercase","color":"#5A5C74"}}>Sayda İnşaat · Since 1996</div>
  </div>
</section>
...
<section data-screen-label="CTA" style={{"position":"relative","background":"#0D1533","color":"#fff","overflow":"hidden"}}>
  ...
  <div style={{"position":"relative","maxWidth":"1400px","margin":"0 auto","padding":"110px 40px","display":"flex","flexWrap":"wrap","justifyContent":"space-between","alignItems":"flex-end","gap":"40px"}}>
    ...
    <div style={{"display":"flex","flexWrap":"wrap","gap":"12px"}}>
      <a href="#" style={{"display":"flex","alignItems":"center","gap":"12px","height":"56px","padding":"0 30px","background":"#3E43B8","color":"#fff","fontSize":"14px","fontWeight":"700","letterSpacing":"0.08em","textTransform":"uppercase"}} className="vizyonmisyon-h4">Teklif Al <span>→</span></a>
      <a href="tel:+902122238812" style={{"display":"flex","alignItems":"center","height":"56px","padding":"0 30px","border":"1.5px solid #8589E6","color":"#F6F7FB","fontSize":"14px","fontWeight":"700","letterSpacing":"0.08em"}} className="vizyonmisyon-h5">+90 212 223 88 12</a>
    </div>
  </div>
</section>
  ...
  <div style={{"maxWidth":"1400px","margin":"0 auto","padding":"90px 40px 60px","display":"grid","gridTemplateColumns":"repeat(auto-fit,minmax(220px,1fr))","gap":"56px"}}>
    <div style={{"gridColumn":"span 2","maxWidth":"420px"}}>
      ...
      <div style={{"display":"flex","gap":"10px","marginTop":"28px"}}>
        <a href="https://www.instagram.com/saydainsaat" style={{"display":"flex","alignItems":"center","justifyContent":"center","height":"40px","padding":"0 16px","border":"1px solid rgba(255,255,255,0.2)","fontSize":"12px","fontWeight":"600","letterSpacing":"0.1em","color":"#fff"}} className="vizyonmisyon-h6">INSTAGRAM</a>
        <a href="#" style={{"display":"flex","alignItems":"center","justifyContent":"center","height":"40px","padding":"0 16px","border":"1px solid rgba(255,255,255,0.2)","fontSize":"12px","fontWeight":"600","letterSpacing":"0.1em","color":"#fff"}} className="vizyonmisyon-h7">LINKEDIN</a>
      </div>
    </div>
      ...
      <div>
        ...
        <div style={{"display":"flex","flexDirection":"column","gap":"12px"}}>
          {(fc.links || []).map((l, $index) => (<React.Fragment key={$index}>
            <a href="#" style={{"fontSize":"15px","color":"rgba(255,255,255,0.75)"}} className="vizyonmisyon-h8">{l}</a>
          </React.Fragment>))}
        </div>
      </div>
    </React.Fragment>))}
  ...
  <div style={{"borderTop":"1px solid rgba(255,255,255,0.1)"}}>
    <div style={{"maxWidth":"1400px","margin":"0 auto","padding":"26px 40px","display":"flex","flexWrap":"wrap","justifyContent":"space-between","gap":"16px","fontSize":"13px","color":"rgba(255,255,255,0.5)"}}>
      ...
      <div style={{"display":"flex","gap":"24px"}}>
        <a href="#" style={{"color":"rgba(255,255,255,0.5)"}} className="vizyonmisyon-h9">Gizlilik Politikası</a>
        <a href="#" style={{"color":"rgba(255,255,255,0.5)"}} className="vizyonmisyon-h10">KVKK Aydınlatma Metni</a>
      </div>
    </div>
  </div>
</footer></div>
